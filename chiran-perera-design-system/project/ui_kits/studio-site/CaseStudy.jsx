...
function Tile({ label, n, tall, wide, img }) {
  return (
...
function CaseStudy({ slug, go }) {
  ...
  return (
    <div className="case" style={{ "--accent": p.accent, "--accent-soft": hexA(p.accent, .12), "--accent-line": hexA(p.accent, .45) }}>
      ...
      {/* NEXT PROJECT */}
      <div className="next" onClick={() => go("case:" + nextP.slug)} style={{ "--accent": nextP.accent }}>

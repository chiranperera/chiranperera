  ...
  return (
    <div className="page-bar">
      ...
      <div className="r">
        ...
        <a className="nav-link" style={{ color: "#fff" }} onClick={onMenu}>Menu</a>
      </div>
    </div>
  );
}
...
function WorkPage({ go, onMenu }) {
  ...
  return (
    <div className="case" style={{ "--accent": "#D8FF3E" }}>
      <PageBar go={go} onMenu={onMenu} />
      <section className="wrap page-hero" style={{ paddingBottom: 0 }}>
        ...
        <div className="work-index">
          {list.map((p) => (
            <article className="wi" key={p.slug} onClick={() => go("case:" + p.slug)} style={{ "--accent": p.accent }}>
              <div className="media">
    ...
    <div className="case" style={{ "--accent": "#D8FF3E" }}>
      ...
      <section className="wrap">
        <div className="studio-two">
          ...
          <div className="portrait"><img src="../../assets/chiran-portrait.jpg" alt="Chiran Perera" /></div>
        </div>
      </section>
      <section className="wrap">
      ...
      <section className="wrap">
        <div className="stat-row">
          {[["50", "+", "Brands designed"], ["6", " yrs", "Studio experience"], ["99", "%", "Repeat clients"], ["3", " wks", "Site to launch"]].map(([b, u, l]) => (
...
/* ---------- SERVICES ---------- */
function ServicesPage({ go, onMenu }) {
  const svc = [
...
/* ---------- CONTACT ---------- */
function ContactPage({ go, onMenu }) {
...
Object.assign(window, { WorkPage, StudioPage, ServicesPage, ContactPage });
